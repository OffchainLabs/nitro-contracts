...
interface NodeInterface {
     ...
     * @param excessFeeRefundAddress (gasLimit x maxFeePerGas - execution) + (autoredeem ? maxSubmission cost : (maxSubmission - submission)) cost gets credited here on L2 balance
