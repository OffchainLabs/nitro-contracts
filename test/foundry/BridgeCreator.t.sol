...
contract BridgeCreatorTest is Test {
    ...
    address[] batchPosters = [address(137)];
    address batchPosterManager = address(340);
    ...
    function test_createEthBridge() public {
        ...
        assertEq(seqInbox.batchPosterManager(), batchPosterManager, "Invalid batch poster");
        assertTrue(seqInbox.isBatchPoster(batchPosters[0]), "Invalid batch poster");
