...
contract UintUtilsLibTest is Test {
    ...
    function testLsb() public {
        ...
        assertEq(
            UintUtilsLib.leastSignificantBit(236945758459398306981350710526416285671374848), 14
        ); // 1010101000000000000100000000010101010100000000000010101000000000000000001010100000000000010101001000101010000000000000000010100001000100000000000000
    ...
    function testMsb() public {
        ...
        assertEq(
            UintUtilsLib.mostSignificantBit(236945758459398306981350710526416285671374848), 147
        ); // 1010101000000000000100000000010101010100000000000010101000000000000000001010100000000000010101001000101010000000000000000010100001000100000000000000
