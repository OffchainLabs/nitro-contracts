...
contract EdgeChallengeManagerTest is Test {
    ...
    function testCanConfirmByClaim() public {
        ...
        (bytes32[] memory states1,, BisectionChildren[6] memory edges1, BisectionChildren[6] memory edges2) =
        createBlockEdgesAndBisectToFork(
            CreateBlockEdgesBisectArgs(
                ei.challengeManager,
                ei.a1,
        ...
        vm.expectRevert(
            abi.encodeWithSelector(EdgeClaimMismatch.selector, edges2[0].lowerChildId, edges1[0].lowerChildId)
        );
