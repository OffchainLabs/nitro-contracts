...
describe('Validator Wallet', () => {
  ...
  before(async () => {
    ...
    rollupMock1 = (await RollupMock.deploy(await rollupOwner.getAddress())) as RollupMock
    rollupMock2 = (await RollupMock.deploy(await rollupOwner.getAddress())) as RollupMock
