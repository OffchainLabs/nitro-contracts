...
export class Toolkit4844 {
  ...
  public static async sendBlobTx(
    ...
    const blobCommand = `docker run --network=nitro-testnode_default ethpandaops/goomy-blob:master-linux-arm64 blob-sender -p ${privKey} -r http://geth:8545 -t ${to} -d ${data} --gaslimit 1000000${blobStr} 2>&1`
